    ...
    "IN": [
        {
            ...
            "definition": "A standalone electronic device used to record votes. It consists of a Control Unit and a Balloting Unit.",
            "example": "In the 2024 Lok Sabha elections, over 5 million EVMs were deployed."
        },
        {
            "term": "VVPAT",
            "short": "Voter Verifiable Paper Audit Trail",
            "definition": "A machine attached to the EVM that prints a paper slip showing the symbol and candidate the voter chose, allowing them to verify their vote.",
        ...
        },
        {
            ...
            "example": "You should bring your EPIC to the polling booth, but other IDs are also accepted if you are on the roll."
        },
        {
            "term": "Model Code of Conduct",
            "short": "MCC",
            "definition": "A set of guidelines issued by the Election Commission of India for conduct of political parties and candidates during elections mainly with respect to speeches, polling day, polling booths, portfolios, election manifestos, processions and general conduct.",
        ...
        },
        {
            ...
            "short": "RO",
            "definition": "The statutory authority responsible for the conduct of the election in a constituency. They are typically district magistrates.",
            "example": "The Returning Officer scrutinizes nomination papers and officially declares the result."
        },
        {
            "term": "Presiding Officer",
            "short": "PO",
            "definition": "The official in charge of a specific polling station on election day.",
            "example": "The Presiding Officer ensures the EVMs are functioning and the polling is conducted fairly."
        },
        {
            "term": "Form 6",
        ...
        },
        {
            ...
            "definition": "The form used to request corrections in the electoral roll, such as a change of address or name.",
            "example": "If you move to a new city, submit Form 8 to transfer your registration."
        },
        {
             "term": "Form 26",
             "short": "Candidate Affidavit",
             "definition": "A sworn document filed by candidates detailing their assets, liabilities, educational qualifications, and criminal records (if any).",
             "example": "Voters can review a candidate's Form 26 on the ECI website to make an informed choice."
        },
        {
            "term": "FPTP",
            "short": "First Past The Post",
            "definition": "An electoral system where the candidate with the most votes in a constituency wins, even if they don't have an absolute majority.",
    ...
    "US": [
         {
            ...
            "short": "EC",
            "definition": "The group of presidential electors required by the Constitution to form every four years for the sole purpose of electing the president and vice president.",
    ...
    "AU": [
         {
             ...
             "short": "Ranked Voting",
             "definition": "A system where voters rank candidates in order of preference. If no candidate gets an absolute majority, the candidate with the fewest votes is eliminated and their votes are distributed according to the next preferences.",
